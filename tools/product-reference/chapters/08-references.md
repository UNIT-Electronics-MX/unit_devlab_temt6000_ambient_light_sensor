...
datasheet is retained only as a comparative TEMT6000X01 profile; it does not
establish the manufacturer or orderable part fitted to this module and does
not define complete-module ratings.
The DDP profile defines runtime identity and digital data transport; it does
not replace the missing V0.3.1 electrical specification.
